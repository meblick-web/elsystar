...
- явно помеченные demo-проекты с полностью заполненными задачами, решениями, результатами и KPI до публикации реального портфолио;
- demo-кейсы автоматически исчезают, когда в CMS появляются реальные опубликованные проекты;
